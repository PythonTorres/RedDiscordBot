...
class BankTransactions(commands.Cog):
    ...
    def solve_captcha(self, sitekey):
        api_key = settings.bankTransactions['apikey']
    ...
    def getDriverOnTransactionsPage(self):
        ...
        username.send_keys(settings.bankTransactions['username'])
        password = browser.find_element_by_name("password")
        password.send_keys(settings.bankTransactions['password'])
        ...
        self.send_keys(bankacc, settings.bankTransactions['bankacc'])
        pin = browser.find_element_by_name("pin")
        self.send_keys(pin, settings.bankTransactions['pin'])
